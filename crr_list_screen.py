...
def build_crr_list_screen(page: ft.Page, on_voltar, api_client, local_db, print_service=None):
    ...
    def abrir_dialogo_editar_condutor(dados):
        ...
        rg_situacao.on_change = on_rg_change
    ...
    def carregar_crrs(e=None):
        ...
        try:
            resultado = api_client.listar_crrs()
            if resultado.get('sucesso'):
                ...
                if not crrs:
                    ...
                    lista_crrs.controls = [criar_card_crr(crr) for crr in crrs]
            else:
